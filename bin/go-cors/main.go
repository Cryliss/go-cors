...
func args() {
	...
	flag.StringVar(&method, "method", "", "Include another method other than `GET`")
	flag.StringVar(&file, "input", "", "A text file with a list of domains to scan for CORS misconfiguration")
	flag.IntVar(&threads, "threads", 40, "Number of threads to use for the scan. Default: 40")
	...
	flag.StringVar(&timeout, "Timeout", "", "Set the request timeout. Default: 10s")
